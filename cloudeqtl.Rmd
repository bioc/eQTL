...
and management of EC2 based machinery is quite simple.  The bulk of the complete run described here
...
For chromosome 1, a rescue run was required with a larger instance
type (m3.2xlarge).
